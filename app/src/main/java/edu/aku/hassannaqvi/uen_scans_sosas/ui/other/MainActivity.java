...
import edu.aku.hassannaqvi.uen_scans_sosas.ui.SectionDAActivity;
import edu.aku.hassannaqvi.uen_scans_sosas.ui.SectionEActivity;
            ...
            if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.getAction())) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    if (DownloadManager.STATUS_SUCCESSFUL == cursor.getInt(colIndex)) {
                        ...
                        bi.lblAppVersion.setText("SCANS-SOSAS APP New Version " + newVer + "  Downloaded.");
...
//                    InstallNewApp(newVer, preVer);
                    ...
                    if (networkInfo != null && networkInfo.isConnected()) {
                        ...
                        bi.lblAppVersion.setText("SCANS-SOSAS APP New Version " + newVer + " Downloading..");
                        downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                        ...
                        request.setDestinationInExternalPublicDir(fileName, versionAppContract.getPathname())
                                ...
                                .setTitle("Downloading SCANS-SOSAS App new App ver." + newVer);
                        ...
                        bi.lblAppVersion.setText("SCANS-SOSAS App New Version " + newVer + "  Available..\n(Can't download.. Internet connectivity issue!!)");
                    }
                }
...
//            new GetFamilyMembersData(this).execute();
    ...
    public void onBackPressed() {
        if (exit) {
            if (MainApp.wrapperFlag) ActivityCompat.finishAffinity(this);
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setTitle("SCANS-SOSAS APP is available!")
                    .setCancelable(false)
                    .setMessage("SCANS-SOSAS App " + newVer + " is now available. Your are currently using older version " + preVer + ".\nInstall new version to use this app.")
